 ...
 *
 * @brief       Boilerplate Application Class
...
namespace IPS\boilerplate;

/**
 * IPS Boilerplate Application Class
 */
class _Application extends \IPS\Application
{
	...
	public function init()
	{
		...
		if ( !\IPS\Member::loggedIn()->group['g_view_board'] and ( \IPS\Request::i()->module == 'boilerplate' and \IPS\Request::i()->controller == 'main' and \IPS\Request::i()->do == 'rss' ) )
		{
	...
	public function defaultFrontNavigation()
	{
		return array(
			'rootTabs'		=> array(),
			'browseTabs'	=> array( array( 'key' => 'Boilerplate' ) ),
			'browseTabsEnd'	=> array(),
			'activityTabs'	=> array()
		);
	}
